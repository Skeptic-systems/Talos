							...
							<div className="space-y-2">
								...
								<div className="relative">
									<Input
										...
										onBlur={field.handleBlur}
										onChange={(e) => field.handleChange(e.target.value)}
										className="border-zinc-700 bg-zinc-800/50 pr-10 text-zinc-100 placeholder:text-zinc-500 focus:border-blue-500"
									/>
									<button
										type="button"
								...
								<div className="mt-2 space-y-1 text-xs">
									<p
										className={`flex items-center gap-1 ${field.state.value.length >= 8 ? "text-green-400" : "text-zinc-500"}`}
									>
									...
									<p
										className={`flex items-center gap-1 ${/[A-Z]/.test(field.state.value) ? "text-green-400" : "text-zinc-500"}`}
									>
									...
									<p
										className={`flex items-center gap-1 ${/\d/.test(field.state.value) ? "text-green-400" : "text-zinc-500"}`}
									>
