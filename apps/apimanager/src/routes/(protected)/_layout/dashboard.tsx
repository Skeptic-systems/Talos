	...
	return (
		<>
			<div className="mb-8">
				...
				<p className="mt-1 text-zinc-400">Welcome back, {session.user?.name}</p>
			</div>
			...
			<div className="mt-8 rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 backdrop-blur-sm">
				...
				<div className="space-y-3">
					...
					<div className="flex justify-between">
						...
						<span className="inline-flex items-center gap-1.5 rounded-full bg-blue-500/10 px-2.5 py-0.5 font-medium text-blue-400 text-xs capitalize">
